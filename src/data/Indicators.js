const indicators = [
  ...
  },
  {
    ...
    <p>Also the National Recovery and Resilience Plans (NRRPs, to be submitted by April 2021) will provide an element for assessing the credibility of the national renovation strategies. The criteria for the assessment will include the targets set for 2030 and 2050, the financial framework and measures to support vulnerable households. </p>
    <p><b>This section of the Dashboard will be updated early 2022</b>. </p>
    <p>Already available information:</p>
    <p><a href="https://ec.europa.eu/energy/sites/default/files/swd_commission_preliminary_analysis_of_member_state_ltrss.pdf" target="_blank">Analysis of the LTRS</a>: On 15 December 2021, the European Commission published a Staff Working Document assessing the 26 LTRS that were availble.</p>
